...
try:
  while True:
    for i in pcmax_datas:
      ...
      options.set_capability("deviceName", "BishiのiPhone")  # 任意（例: iPhone 15）
      options.set_capability("udid", "00008130-0016682128A1401C")   # 実機のUDID
      options.set_capability("automationName", "XCUITest")
      options.set_capability("browserName", "Safari")
      options.set_capability("autoAcceptAlerts", True)
      options.set_capability("xcodeOrgId", "<あなたのチームID>")
